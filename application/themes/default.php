...
<head>
    <meta charset="UTF-8" />
    <title>BCORE Admin Dashboard Template | <?= $title ?> </title>
    ...
    <link rel="stylesheet" href="<?= css_url('theme') ?>" />
    <link rel="stylesheet" href="<?= css_url('MoneAdmin') ?>" />
    <link rel="stylesheet" href="<?= plugins_url('Font-Awesome/css/font-awesome.css') ?>" />
    <!--END GLOBAL STYLES -->

    <!-- PAGE LEVEL STYLES -->
    <link href="<?= css_url('layout2') ?>" rel="stylesheet" />
       <link href="<?= plugins_url('flot/examples/examples.css') ?>" rel="stylesheet" />
       <link rel="stylesheet" href="<?= plugins_url('timeline/timeline.css') ?>" />
    <!-- END PAGE LEVEL  STYLES -->
    <link href="<?= plugins_url('dataTables/dataTables.bootstrap.css') ?>" rel="stylesheet" />
...
<body class="padTop53 " >
    ...
    <div id="wrap" >
        ...
        <div id="left" >
            <div class="media user-media well-small">
                <a class="user-link" href="#">
                    <img class="media-object img-thumbnail user-img" alt="User Picture" src="<?= asset_url('img/user.gif') ?>" />
                </a>
                <br />
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel <?= (isset($accueil_nav))? $accueil_nav : "" ?>">
                    <a href="<?= base_url('accueil') ?>" >
                        <i class="icon-table"></i> Accueil
                    </a>                   
                </li>


                <li class="panel <?= (isset($user_nav))? $user_nav : "" ?>">
                    <a href="<?= base_url('utilisateur') ?>" >
        ...
        <!--PAGE CONTENT [passage de la vue] -->
        <?= $output; ?>
        <!--END PAGE CONTENT -->
    ...
    <!-- FOOTER -->
    <?= (isset($outputfooter))? $outputfooter : '' ?>
    <!--END FOOTER -->

    <!-- GLOBAL SCRIPTS -->
    <script src="<?= asset_url('plugins/jquery-2.0.3.min.js') ?>"></script>
    <script src="<?= asset_url('plugins/bootstrap/js/bootstrap.min.js') ?>"></script>
    <script src="<?= asset_url('plugins/modernizr-2.6.2-respond-1.1.0.min.js') ?>"></script>
    <!-- END GLOBAL SCRIPTS -->

    <!-- PAGE LEVEL SCRIPTS -->
    <script src="<?= asset_url('plugins/flot/jquery.flot.js') ?>"></script>
    <script src="<?= asset_url('plugins/flot/jquery.flot.resize.js') ?>"></script>
    <script src="<?= asset_url('plugins/flot/jquery.flot.time.js') ?>"></script>
    <script  src="<?= asset_url('plugins/flot/jquery.flot.stack.js') ?>"></script>
    <script src="<?= asset_url('js/for_index.js') ?>"></script>


    <!-- PAGE LEVEL SCRIPTS -->
    <script src="<?= plugins_url('dataTables/jquery.dataTables.js') ?>"></script>
    <script src="<?= plugins_url('dataTables/dataTables.bootstrap.js') ?>"></script>
    <script>
    ...
    <!-- START: OTHER JAVASCRIPTS  -->
    <?php foreach($js as $url): ?> <script type="text/javascript" src="<?php echo $url; ?>"></script> <?php endforeach; ?>
    <?php foreach($page_js as $url): echo $url; endforeach; ?>
    <!-- END: OTHER JAVASCRIPTS  -->
